  ...
  const handleConfirm = () => {
    Swal.fire({
      ...
      if (result.isConfirmed) {
        ...
        Swal.fire('dikonfirmasi!', 'Pesanan Anda Berhasil dikonfirmasi.', 'success').then(() => {
          navigateBack();
        });
      }
    });
              ...
              <div className="p-3 py-5">
                ...
                <div className="row mt-3">
                  ...
                  <div className="col-md-12">
                    ...
                    <p>{moment(order?.start_rent_at).format('DD MMMM YYYY')}</p>
                  </div>
                  <div className="col-md-12">
                    <label className="labels">
                      <strong>Tanggal Berakhir</strong>
                    </label>
                    <p>{moment(order?.finish_rent_at).format('DD MMMM YYYY')}</p>
                  </div>
                  <div className="col-md-12">
                    <label className="labels">
                      <strong>Total Bayar</strong>
                    </label>
                    <p>{formatter.format(order?.total_price)}</p>
                  </div>
                </div>
