    ...
    <>
      ...
      <Button
        ...
        style={{
          ...
          border: category === 'small' ? '1px solid #0D28A6' : '1px solid #AEB7E1',
          borderRadius: '2px',
          fontFamily: 'Arial',
          fontStyle: 'normal',
          fontWeight: 700,
      ...
      <Button
        ...
        style={{
          ...
          border: category === 'medium' ? '1px solid #0D28A6' : '1px solid #AEB7E1',
          borderRadius: '2px',
          fontFamily: 'Arial',
          fontStyle: 'normal',
          fontWeight: 700,
      ...
      <Button
        ...
        style={{
          ...
          border: category === 'large' ? '1px solid #0D28A6' : '1px solid #AEB7E1',
          borderRadius: '2px',
          fontFamily: 'Arial',
          fontStyle: 'normal',
          fontWeight: 700,
